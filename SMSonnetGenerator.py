...
log_file_path = "/home/ec2-user/latency-test/NEW_SCRIPTS/logs/SMSonnet.log"
stats_file_path = "/home/ec2-user/latency-test/NEW_SCRIPTS/logs/Stats_SMSonnet.log"
db_file_path = "/home/ec2-user/latency-test/NEW_SCRIPTS/Charging.db"

#Logger definition for log files
logger = logging.getLogger("SMSOnnet")
...
stats_logger = logging.getLogger("Stats_SMSOnnet")
...
async def main():
    ...
    for row in results:
        ...
        all_results=sums
    print(all_results)
    stats_logger.info('SMSOnnet, %s',str(all_results))
