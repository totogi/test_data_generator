...
log_file_path = "/home/ec2-user/latency-test/NEW_SCRIPTS/logs/SMSoffnet.log"
stats_file_path = "/home/ec2-user/latency-test/NEW_SCRIPTS/logs/Stats_SMSoffnet.log"
db_file_path = "/home/ec2-user/latency-test/NEW_SCRIPTS/Charging.db"

#Logger definition for log files
logger = logging.getLogger("SMSOffnet")
...
stats_logger = logging.getLogger("Stats_SMSOffnet")
...
async def main():
    ...
    for row in results:
        ...
        all_results=sums
    print(all_results)
    stats_logger.info('SMSOffnet, %s',str(all_results))
