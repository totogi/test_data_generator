...
log_file_path = "/home/ec2-user/latency-test/NEW_SCRIPTS/logs/Voiceonnet.log"
stats_file_path = "/home/ec2-user/latency-test/NEW_SCRIPTS/logs/Stats_Voiceonnet.log"
db_file_path = "/home/ec2-user/latency-test/NEW_SCRIPTS/Charging.db"

#Logger definition for log files
logger = logging.getLogger("VoiceOnnet")
...
stats_logger = logging.getLogger("Stats_VoiceOnnet")
                        ...
                        "multipleUnitUsage": [
                                ...
                                "iMSChargingInformation": {
                                   ...
                                   "carrierSelectRoutingInformation": self.routeinfo,
                                    "numberPortabilityRoutingInformation":self.mnpinfo 
                                 },
