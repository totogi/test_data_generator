...
class VoiceonnetGeneratorClass:
    def __init__(self):
    ...
    async def consume_voiceonnet(self,device_id,access_token):
        ...
        init_count += 1
        f = open('/home/ec2-user/latency-test/FINAL_SCRIPTS/voiceonnet.log', 'a')
