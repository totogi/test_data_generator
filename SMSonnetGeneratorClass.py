...
class SMSonnetGeneratorClass:
    ...
    async def init(self,token, device_id,init_requ_units,called_number):
        ...
        "carrierSelectRoutingInformation": "ORSP",
        "numberPortabilityRoutingInformation": "ORSP"
        },
    ...
    async def consume_SMSonnet(self,device_id,access_token):
        init_requ_units=random.randrange(1, 20,2)
        print("init_requ_units " + str(init_requ_units))
        up_consumed_units=random.randrange(1, 20,2)
        ...
        print("up_consumed_units " + str(up_consumed_units))
        update_requ_units=random.randrange(1, 20,2)
        print("Up requ units " + str(update_requ_units))
        tr_consumed_units=random.randrange(1, 20,2)
        ...
        init_count += 1
        f = open('/home/ec2-user/latency-test/FINAL_SCRIPTS/SMSonnet.log', 'a')
