...
log_file_path = "/home/ec2-user/latency-test/NEW_SCRIPTS/logs/Data.log"
stats_file_path = "/home/ec2-user/latency-test/NEW_SCRIPTS/logs/Stats_Data.log"
...
stats_logger = logging.getLogger("Stats_Data")
...
class EventGeneratorClass:
        def __init__(self):
                ...
                self.data_session_sr = 1048576     #This will be starting range of the data session volume
                self.data_session_er = 104857600   #This will be ending range of the data session volumne
                self.data_session_in = 1048576     #This will be data volume increment units to select the random consumption units
