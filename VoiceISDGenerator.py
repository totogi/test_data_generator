...
log_file_path = "/home/ec2-user/latency-test/NEW_SCRIPTS/logs/VoiceISD.log"
stats_file_path = "/home/ec2-user/latency-test/NEW_SCRIPTS/logs/Stats_VoiceISD.log"
db_file_path = "/home/ec2-user/latency-test/NEW_SCRIPTS/Charging.db"

#Logger definition for log files
logger = logging.getLogger("VoiceISD")
...
stats_logger = logging.getLogger("Stats_VoiceISD")
