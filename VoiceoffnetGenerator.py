...
log_file_path = "/home/ec2-user/latency-test/NEW_SCRIPTS/logs/Voiceoffnet.log"
stats_file_path = "/home/ec2-user/latency-test/NEW_SCRIPTS/logs/Stats_Voiceoffnet.log"
db_file_path = "/home/ec2-user/latency-test/NEW_SCRIPTS/Charging.db"

#Logger definition for log files
logger = logging.getLogger("VoiceOffnet")
...
stats_logger = logging.getLogger("Stats_VoiceOffnet")
...
class EventGeneratorClass:
        def __init__(self):
                ...
                self.data_session_sr = 100     #This will be starting range of the data session volume
                self.data_session_er = 1000   #This will be ending range of the data session volumne
                ...
                payload = {
                        ...
                        "multipleUnitUsage": [
                                ...
                                "iMSChargingInformation": {
                                   ...
                                   "carrierSelectRoutingInformation": self.routeinfo,
                                    "numberPortabilityRoutingInformation":self.offnet
                                 },
        ...
        async def consume_data(self,device_id):
                for i in range(1):
                        ...
                        called_number = random.randint(695000000, 695999999)
...
async def main():
    ...
    hrdata = conn.cursor()
    hrdata.execute("SELECT voice_offnet  FROM call_stats  where HOUR=?",[hrnow])
    ...
    for row in results:
        ...
        all_results=sums
    print(all_results)
    stats_logger.info('VoiceOffnet, %s',str(all_results))
